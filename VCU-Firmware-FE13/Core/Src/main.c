...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : VBAT_MEASURE_DONOTUSE_Pin */
  GPIO_InitStruct.Pin = VBAT_MEASURE_DONOTUSE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(VBAT_MEASURE_DONOTUSE_GPIO_Port, &GPIO_InitStruct);
